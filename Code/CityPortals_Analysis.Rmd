...
16 cities have more than one library system. New Orleans is not included in these results but has two rows in the data because it has two city data portals.
...
There doesn't appear to be a relationship between the proportion of data in a city portal that is library data and the Open Data Census score from 2017.
